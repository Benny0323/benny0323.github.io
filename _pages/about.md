...
🔖 Services: 
- Reviewer of [Biomedical Signal Processing and Control (BSPC)](https://www.sciencedirect.com/journal/biomedical-signal-processing-and-control) and [Heliyon](https://www.cell.com/heliyon/home).
...
- *2025.09 - Now*, Master student: Computer Science and Engineering, [Southeast University](https://www.seu.edu.cn), Nanjing, China
...
# 🔥 News
- *2026.02*: &nbsp;🎉🎉 I’m excited to share that I’ve been invited to serve as a **reviewer for [Heliyon](https://www.cell.com/heliyon/home)**!
...
# 🔬 Patent
一种使用稀疏标注的基于阈值Prompt和SAM微调的CBCT投影域金属轨迹分割及金属伪影移除算法（发明受理）
